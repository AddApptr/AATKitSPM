...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "GoogleMobileAds", url: "https://github.com/googleads/swift-package-manager-google-mobile-ads", .exact("9.14.0")),
        ...
        .package(name: "TeadsSDK", url: "https://github.com/teads/TeadsSDK-iOS", .exact("5.0.22")),
    ],
    targets: [
        // AATKit target
