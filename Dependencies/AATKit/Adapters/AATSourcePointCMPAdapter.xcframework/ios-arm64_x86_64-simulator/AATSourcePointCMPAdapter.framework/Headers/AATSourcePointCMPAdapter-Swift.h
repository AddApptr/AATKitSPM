...
#ifndef AATSOURCEPOINTCMPADAPTER_SWIFT_H
#define AATSOURCEPOINTCMPADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AATSourcePointCMPAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface AATCMPSourcepoint (SWIFT_EXTENSION(AATSourcePointCMPAdapter)) <SPDelegate>
...
@interface AATCMPSourcepoint (SWIFT_EXTENSION(AATSourcePointCMPAdapter)) <AATCMPProtocol>
