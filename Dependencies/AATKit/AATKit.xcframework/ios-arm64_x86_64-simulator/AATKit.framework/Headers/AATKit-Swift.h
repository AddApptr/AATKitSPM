...
/// \param forceShowMraidCloseButton An option to force showing the SDK native close button even if the MRAID creative has one. If the MRAID creative has close button and <code>forceCloseButtonForMraid</code> is true, the MRAID creative would have 2 close buttons
///
